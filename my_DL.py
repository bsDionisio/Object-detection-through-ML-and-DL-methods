...
import numpy as np
import torch
from DL_algorithms.SuperPoint.superpoint_pytorch import SuperPoint
from DL_algorithms.SuperPoint.notebooks.utils import plot_imgs
...
class DL:
    ...
    def find_matches(self, frame):
        ...
        cv2.imshow('SuperPoint', img_matches)
        ...
        print("Number of Keypoints Detected In The Sample Image: ", len(keypoints1_cv))
